    ...
    data=dict(
        train=dict(
            dataset=dict(
                ...
                root=dataset_root,
                ann_file='/media/data/home/tianhewang/Datasets/x-ray'
                         '/proj-x-ray/ks_0_train.json',
                img_prefix='',
                multi_label=multi_label,
                seg_list='/media/data/home/tianhewang/Datasets/x-ray'
                         '/proj-x-ray/ks_0_half_train.json',
            ),
            transforms=[
                dict(type='LongestMaxSize', h_max=size_h, w_max=size_w,
                     interpolation=cv2.INTER_LINEAR),
